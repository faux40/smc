...
class TrainingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'cert_text_line_1' => ['nullable', 'string', 'max:255'],
            'cert_text_line_2' => ['nullable', 'string', 'max:255'],
            'cert_text_line_3' => ['nullable', 'string', 'max:255'],
            'cert_text_line_4' => ['nullable', 'string', 'max:255'],
            ...
            'default_training_location' => ['nullable', 'string', 'max:255'],
            'default_training_address' => ['nullable', 'string', 'max:1000'],
