...
/*
 * Completions tab of the Reports page — server-paged table of completions with
 * date range / training / user / tag / status filters. "Export PDF…" opens the
 * grouping modal, whose PDF + CSV links stream the full filtered set (same
 * filters + visible columns + grouping, as a query string).
 */
    ...
    <div class="flex flex-col gap-6">
        <div class="flex items-start justify-between gap-4">
            <p class="max-w-3xl text-sm text-muted-foreground">
                Every recorded completion, filterable by date, training, user,
                and tag. Export the filtered set to PDF or CSV.
            </p>
            <Button
                variant="outline"
                size="sm"
